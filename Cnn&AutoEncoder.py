...
def CreateTheCnnAutoGaussModel():
...
def CnnAutoEncoderGauss():
    ...
    def initialize_model(learning_rate):
        CnnAutoModel = CreateTheCnnAutoGaussModel()
        loss_function = nn.MSELoss() ## The Data not Normalized so Use BCE With Log
    ...
    CnnAutoModel, loss_function, optimizer = initialize_model(learning_rate)
